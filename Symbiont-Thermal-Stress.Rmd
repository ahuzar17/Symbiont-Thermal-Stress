...
```
As mentioned before, both the control and heat group have 8 samples whereas the cool group only has 4 samples. Control_1.1 has the highest raw counts of 1285858, and Cool_1 has the lowest raw count of 484972.
