...
Figure 3.7: GO enrichment results for the Turquoise module, looking at Biological Processes. There are 5 GO terms at 10% FDR. Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  The fractions to the left of each GO term display the number of enriched terms in the numerator, over the total number of go terms in that unit in the denominator.
...
##### GreenYellow:
Correlated with heat treatment
...
##### Magenta:
Correlated with cool treatment.
...
##### Brown: 
Correlated with heat treatment and cell density
...
Figure 3.16: GO enrichment results for the Brown module, looking at BP. There are 192 GO terms at 10% FDR.Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.001, and <0.0001.  The fractions to the left do not denote anything, and should be ignored for this figure.
...
Figure 3.17: GO enrichment results for the Brown module, looking at MF. There are 41 GO terms at 10% FDR. Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.001, and <0.001.  The fractions to the left do not denote anything, and should be ignored for this figure.
