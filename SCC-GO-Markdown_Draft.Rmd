...
```{r}
setwd("/usr4/bi594/ebrenner/ondemand/Final Project GIT 2")
```
...
```
Figure 3.2: GO enrichment results for the cool treatment, looking at Cellular Componants.  Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  Blue represents downregulation, and red represents upregulation.  The fractions to the left of each GO term display the number of enriched terms in the numerator, over the total number of go terms in that unit in the denominator.
...
The above GO analysis uses the information we collected from DeSeq, but we can also apply GO to the outputs of WGCNA analysis.  Looking at the results of WGCNA, we know there were 4 modules of interest: turquoise, greenyellow, magenta, and brown.  We can use the exact same code template as before to see the GO functions of the genes within the module.  Let's take a look at the Turquoise module first: 
...
```
Figure 3.8: GO enrichment results for the Turquoise module, looking at Molecular Functions.  Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  The fractions to the left of each GO term display the number of enriched terms in the numerator, over the total number of go terms in that unit in the denominator.
...
```
Figure 3.9: GO enrichment results for the Turquoise module, looking at Cellular Componants.  Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  The fractions to the left of each GO term display the number of enriched terms in the numerator, over the total number of go terms in that unit in the denominator.
...
```
Figure 3.16: GO enrichment results for the Brown module, looking at BP.  Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  The fractions to the left do not denote anything, and should be ignored for this figure.
...
```
Figure 3.17: GO enrichment results for the Brown module, looking at MF.  Text thickness on the tree signifies goodness of fit, using the p-values <0.01, <0.05, and <0.1.  The fractions to the left do not denote anything, and should be ignored for this figure.
...
## And that concludes GO analysis for this project! 